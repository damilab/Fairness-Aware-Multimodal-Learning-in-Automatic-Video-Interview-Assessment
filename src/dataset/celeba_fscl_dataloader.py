from .transform_fscl import get_fscl_train_transform
...
def get_celeba_fscl_dataloader(
    config: dict,
) -> tuple[DataLoader, DataLoader, DataLoader, DataLoader]:
    train_fscl_transform = get_fscl_train_transform()
    train_transform = get_base_train_transform()
    valid_transform = get_base_val_transform()

    # dataset
    train_fscl_dataset = CelebADataset_MSA(
        root=config["datamodule"]["image_dir"],
        split="train",
        transform=train_fscl_transform,
        download=False,
    ...
    # dataloader
    train_fscl_dataloader = DataLoader(
        train_fscl_dataset,
        shuffle=True,
        drop_last=True,
    ...
    return train_fscl_dataloader, train_dataloader, valid_dataloader, test_dataloader
